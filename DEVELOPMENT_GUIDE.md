...
- Deployment floor: Apple silicon running macOS Sequoia 15.0. The source and opaque custom chrome support Sequoia 15, Tahoe 26, and macOS 27. Hotkeys use native registration when Carbon is importable and compile an AppKit fallback otherwise, avoiding a hard future-SDK dependency without adding Accessibility to today's recording-only workflow. The 2026-07-16 baseline was built with Swift 6.3.3/Xcode 26.6/SDK 26.5 and exercised on macOS 27 beta. Also compile with Xcode 27 before a public macOS 27 release whenever that toolchain is installed. MLX Swift is pinned exactly to stable 0.31.3.
